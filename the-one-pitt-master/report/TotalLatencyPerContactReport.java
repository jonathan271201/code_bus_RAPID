 ...
 */
public class TotalLatencyPerContactReport extends Report implements MessageListener, ConnectionListener {
     ...
     * Constructor.
     */
    public TotalLatencyPerContactReport() {
        init();
    ...
    public void hostsConnected(DTNHost host1, DTNHost host2) {
        ...
        if (totalContact - lastRecord >= interval) {
            ...
            String latenciesValue = getTotal(latencies);
