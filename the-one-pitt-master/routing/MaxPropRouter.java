 ...
 * @version 1.0
 *
 * Extension of the protocol by adding a parameter alpha (default 1) By new
 * connection, the delivery likelihood is increased by alpha and divided by
 * 1+alpha. Using the default results in the original algorithm. Refer to Karvo
 * and Ott, <I>Time Scales and Delay-Tolerant Routing Protocols</I> Chants, 2008
 */
